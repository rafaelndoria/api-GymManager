...
{
    public class AddPlanTimeCommandValidator : AbstractValidator<AddPlanTimeCommand>
    {
        public AddPlanTimeCommandValidator()
        {
            RuleFor(x => x.DayWeekId)
                .NotNull().WithMessage("The day week id is required")
                .GreaterThan(0).WithMessage("The day week id must be greater than 0");
